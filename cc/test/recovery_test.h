...
TEST(CLASS, Serial) {
...

  {
    ...
    // 6 pages!
    FasterKv<Key, Value1, disk_t> store{ 524288, 201326592, "storage", 0, "", 0.4 };
  ...
  // Test recovery.
  FasterKv<Key, Value1, disk_t> new_store{ 524288, 201326592, "storage", 0, "", 0.4 };
...
TEST(CLASS, Concurrent_Insert_Small) {
...

  {
    ...
    // 6 pages!
    store_t store{ 8192, 201326592, "storage", 0, "", 0.4 };
  ...
  // Test recovery.
  store_t new_store{ 8192, 201326592, "storage", 0, "", 0.4 };
...
TEST(CLASS, Concurrent_Insert_Large) {
...

  {
    ...
    // 6 pages!
    store_t store{ 524288, 201326592, "storage", 0, "", 0.4 };
  ...
  // Test recovery.
  store_t new_store{ 524288, 201326592, "storage", 0, "", 0.4 };
...
TEST(CLASS, Concurrent_Rmw_Small) {
  ...
  {
    // 6 pages!
    store_t store{ 8192, 402653184, "storage", 0, "", 0.4 };
  ...
  // Test recovery.
  store_t new_store{ 8192, 402653184, "storage", 0, "", 0.4 };
...
TEST(CLASS, Concurrent_Rmw_Large) {
  ...
  {
    // 6 pages!
    store_t store{ 524288, 402653184, "storage", 0, "", 0.4 };
  ...
  // Test recovery.
  store_t new_store{ 524288 * 2, 402653184, "storage", 0, "", 0.4 };
